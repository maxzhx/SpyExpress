  ...
  function verify_login()
  {
	   ...
	   if(document.getElementById("username").value==""){
		   ...
		   ymPrompt.alert("请输入密码.",220,170,'提示');
		 	...
		 	form1.action="adminLogin.action";
		   	form1.submit();
		 }
  }
</script>
...
<div id="main_container">
    ...
    <div class="logo"><a href="#"><img src="../images/logo.gif" alt="" title="" border="0" /></a></div>
		...
		<div class="login_form">
         ...
         <h3 style="font-size:24px;font-weight: bold;">管理员登录</h3>
        ...
        <s:hidden id="click" name="isclick"/>
                ...
                <fieldset>
                    <dl>
                        ...
                        <dd>
                        <s:textfield name="username" id="username" style="width:180px">
                        </s:textfield>
                    ...
                    <dl>
                        ...
                        <dd>
                        <s:password name="password" id="password" style="width:180px">
                       </s:password>
                    ...
                    <dl style="margin-left:20px;margin-top:50px;">
                     
                    <dt ><input type="checkbox" id="isclick" checked="checked" style="margin-top:-10px"/></dt>
                   	<dd><label>&nbsp;&nbsp;&nbsp;记住我</label></dd>
                    </dl>
                    
                     <dl class="submit">
	                     <input  type="button"  onclick="verify_login();" value="登录" />
                     </dl>
    ...
    <div class="footer_login">
    	...
    	<div class="left_footer_login">Tobacco Logistics System | Powered by <a href="http://indeziner.com">SPY</a></div>
    	<div class="right_footer_login"><a href="http://indeziner.com"><img src="../images/admin_logo.gif" alt="" title="" border="0" /></a></div>
