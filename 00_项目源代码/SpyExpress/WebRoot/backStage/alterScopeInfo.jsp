...
<script>
  function verify_mScope()
  {
	   if((document.getElementById("mscopeFKP").value=="")||(document.getElementById("mscopeKP").value=="")
		||(document.getElementById("mscopeFCP").value=="")||(document.getElementById("mscopeCP").value=="")
		   ||(document.getElementById("mscopedura").value=="")){
		   ymPrompt.alert("信息未填写完整.",240,170,'提示');
	   }
	   else{
		 	form1.action="updateScope.action";
		   	form1.submit();
		 }
  }
  </script>
